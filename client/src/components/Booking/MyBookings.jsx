              ...
              <div key={booking._id} className="bg-white rounded-lg shadow-md overflow-hidden">
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      <h3 className="font-semibold text-secondary mb-1">Show Time</h3>
                      <p className="text-gray-700">
                        {new Date(booking.movieId.showTimes.find(st => st._id.toString() === booking.showTimeId.toString()).date).toLocaleDateString()} | 
                        {booking.movieId.showTimes.find(st => st._id.toString() === booking.showTimeId.toString()).time}
                      </p>
                    </div>
                    <div>
                  ...
                  <div className="flex justify-between items-center border-t border-gray-200 pt-4">
                    ...
                    <span className="text-lg font-bold text-secondary">₹{booking.totalAmount}</span>
                  </div>
                </div>
